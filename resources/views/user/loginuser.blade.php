...
<body class="bg-[url('/assets/22.jpg')] bg-cover">
    <div class="min-h-screen flex items-center justify-center gap-10">
        <div class="md:bg-slate-100 p-8 rounded-lg sm:shadow-2xl w-full max-w-md">
            ...
            <form action="/" method="POST">
                <div class="space-y-4">
                    <div>
                        <label for="username"
                            class="block text-sm font-medium text-white md:text-gray-700">Username</label>
                        <input type="text" id="username" name="username" required class="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md text-sm shadow-sm placeholder-gray-400
                                  focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500">
                    </div>
                    <div>
                        <label for="password"
                            class="block text-sm font-medium text-white md:text-gray-700">Password</label>
                        <div class="relative">
        ...
        <div class="hidden lg:block w-1/4">
            ...
            <h1
                class="text-4xl lg:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-blue-700 to-cyan-900">
                LOGBOOK
            </h1>
            <p class="text-white mt-5 text-3xl font-bold">
                Catat semua keseharian magangmu disini!
            </p>
        </div>
    </div>
