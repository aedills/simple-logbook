                    ...
                    <div class="card-body">
                        ...
                        <form id="aktifitasForm" enctype="multipart/form-data" action="{{ route('user.aktifitasuser.upload.store') }}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input required name="tanggal" type="date" class="form-control" id="tanggal" min="{{session('tgl_mulai')}}" max="{{ \Carbon\Carbon::now()->format('Y-m-d') < session('tgl_selesai') ? \Carbon\Carbon::now()->format('Y-m-d') : session('tgl_selesai') }}" value="{{ \Carbon\Carbon::now()->format('Y-m-d') }}">
                                </div>
                            </div>
                        </form>
