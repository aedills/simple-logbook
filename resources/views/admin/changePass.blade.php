...
<body class="bg-[url('/assets/changepass_bg.jpg')] bg-cover">
    <div class="min-h-screen flex justify-center relative">
        <div class="md:bg-slate-100 p-8 rounded-lg sm:shadow-2xl w-full max-w-md top-28 absolute">
            ...
            <form action="{{route('auth.doChangePass')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="space-y-4">
                    <div>
                        <label for="password" class="block text-sm font-medium text-white md:text-gray-700">Password baru</label>
                        <div class="relative">
